...
void Menu::Render()
{
	...
	ImGui::BeginMenuBackground("ThighHighs & Tranny hake", &g_Menu.bMenuOpened, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoTitleBar | ImGuiConfigFlags_NoMouse); {
...
void Menu::Misc() {
	...
	ImGui::NextColumn(); {
		...
		InsertGroupBoxRight("Other", 332.f); {
			ImGui::Checkbox("Cheat Active", &g_Settings.bCheatActive);
